 ...
 */
package com.att.eelf.sample.exception;

import com.att.eelf.exception.EELFException;

public class MySampleException1 extends EELFException {
     ...
     */
    public MySampleException1(String message) {
        super(message);
    }
     ...
     */
    public MySampleException1(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *            and indicates that the cause is nonexistent or unknown.)
     */
    public MySampleException1(Throwable cause) {
        super(cause);
    }
