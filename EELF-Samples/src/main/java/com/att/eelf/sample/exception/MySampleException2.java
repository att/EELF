...
public class MySampleException2 extends EELFException {
     ...
     */
    public MySampleException2(String message) {
        super(message);
    }
     ...
     */
    public MySampleException2(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *            and indicates that the cause is nonexistent or unknown.)
     */
    public MySampleException2(Throwable cause) {
        super(cause);
    }
