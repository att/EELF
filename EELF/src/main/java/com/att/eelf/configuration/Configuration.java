...
/**
 * This interface defines the configuration support and logger names in EELF. It
 * also defines the MDC key names.
 *
 */
public interface Configuration {

	/**
	 * The name of the property used to define the filename for the logback
	 * configuration
	 */
	 ...
	 * (e.g. Jetty container's listening IP address)
	 */
	 ...
	 * granularity available to the component system. This value should be the
	 * difference between BeginTimestamp and EndTimestamp fields
	 */
	 ...
	 */
	public String MDC_ERROR_CODE = "ErrorCode";

	/**
	 * Error Code defined in the Resource Bundle<br>
	 * #Resource key=Error Code|Message text|Resolution text |Error Description
	 */
	public String MDC_ERROR_DESC = "ErrorDescription";
}
