...
public class TestPolicyLogger {
	
	 private static EELFLogger policyLogger = EELFManager.getPolicyLogger();
	 ...
	 public void testInfoMessages() {
		 String msg = "This is info message for policy logger";
		 policyLogger.info(msg);
		 //assertTrue(checkLogFile(msg, Level.INFO));
		 
		 policyLogger.info("This is {} info message with args {}","dummy","args1");
		 msg = String.format("This is %s info message with args %s","dummy","args1");
		 //assertTrue(checkLogFile(msg, Level.INFO)); 
		 
		 policyLogger.info(SampleApplicationMsgs.MESSAGE_CONFIGURATION_CLEARED);
		 //assertTrue(checkLogFile("APP20002I",Level.INFO)); 
		 
		 policyLogger.info(SampleApplicationMsgs.MESSAGE_CONFIGURATION_STARTED, new Date().toString());
	 ...
	 public void testWarnMessages() {
		 String msg = "This is warn message for policy logger";
		 policyLogger.warn(msg);
		 //assertTrue(checkLogFile(msg, Level.WARN));
		 
		 policyLogger.warn("This is {} warn message with args {}","dummy","args1");
		 msg = String.format("This is %s warn message with args %s","dummy","args1");
		 //assertTrue(checkLogFile(msg, Level.WARN)); 
		 
		 policyLogger.warn(SampleApplicationMsgs.WARN_MSG);
	 ...
	 public void testErrorMessages() {
		 String msg = "This is error message for policy logger";
		 policyLogger.error(msg);
		 //assertTrue(checkLogFile(msg,Level.ERROR));
		 
		 policyLogger.error("This is {} error message with args {}","dummy","args1");
		 msg = String.format("This is %s error message with args %s","dummy","args1");
		 //assertTrue(checkLogFile(msg,Level.ERROR)); 
		 
		 policyLogger.error(SampleApplicationMsgs.ERROR_SERVICE_NOT_RUNNING);
		 //assertTrue(checkLogFile("APP30004E",Level.ERROR)); 
		 
		 policyLogger.error(SampleApplicationMsgs.ERROR_USER_NOT_FOUND, new Date().toString());
	 ...
	 public void testDebugMessages() {
		 String msg = "This is debug message for policy logger not to be logged";
		 policyLogger.debug(msg);
		 //assertFalse(checkLogFile(msg,Level.DEBUG));
		 
		 policyLogger.debug("This is {} debug message with args {}","dummy","args1");
		 msg = String.format("This is %s debug message with args %s","dummy","args1");
		 //assertFalse(checkLogFile(msg,Level.DEBUG)); 
		 
		 policyLogger.debug(SampleApplicationMsgs.DEBUG_MSG);
		 //assertFalse(checkLogFile("APP10006D",Level.DEBUG)); 
	 }
	 
	 @Test
	 public void testTraceMessages() {
		 String msg = "This is trace message for policy logger not to be logged";
		 policyLogger.trace(msg);
		 //assertFalse(checkLogFile(msg,Level.TRACE));
		 
		 policyLogger.trace("This is {} trace message with args {}","dummy","args1");
		 msg = String.format("This is %s trace message with args %s","dummy","args1");
		 //assertFalse(checkLogFile(msg,Level.TRACE)); 
		
		 policyLogger.debug(SampleApplicationMsgs.TRACE_MSG);
	 ...
	 public void testChangeLevel() {
		 policyLogger.setLevel(Level.DEBUG);
		 String msg = "This is debug message for policy logger to be logged";
		 policyLogger.debug(msg);
		 //assertTrue(checkLogFile(msg,Level.DEBUG));
		 
		 policyLogger.setLevel(Level.TRACE);
		 msg = "This is trace message for policy logger to be logged";
		 policyLogger.trace(msg);
	 ...
	 public void testDisableLevel() {
		 policyLogger.disableLogging();
		 String msg = "This is info message for policy logger not to be logged";
		 policyLogger.info(msg);
		 //assertFalse(checkLogFile(msg, Level.INFO));
		 
		 policyLogger.info("This is {} info message with args {} not to be logged","dummy","args1");
	 ...
	 private boolean checkLogFile(String line, Level level) {
		 BufferedReader br = null;
			...
			try {
				...
				br = new BufferedReader(new FileReader("logs/EELF/policy.log"));
