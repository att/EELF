...
public class TestLogger {
	 ...
	 private static EELFLogger LOGGER = EELFManager.getInstance().getLogger("com.att.eelf.test");
	 ...
	 public void testInfoMessages() {
		 String msg = "This is info message for class logger logger";
		 LOGGER.info(msg);
		 //assertTrue(checkLogFile(msg, Level.INFO));
		 
		 LOGGER.info("This is {} info message with args {}","dummy","args1");
		 msg = String.format("This is %s info message with args %s","dummy","args1");
		 //assertTrue(checkLogFile(msg, Level.INFO)); 
		 
		 LOGGER.info(SampleApplicationMsgs.MESSAGE_CONFIGURATION_CLEARED);
		 //assertTrue(checkLogFile("APP20002I",Level.INFO)); 
		 
		 LOGGER.info(SampleApplicationMsgs.MESSAGE_CONFIGURATION_STARTED, new Date().toString());
	 ...
	 public void testWarnMessages() {
		 String msg = "This is warn message for class logger logger";
		 LOGGER.warn(msg);
		 //assertTrue(checkLogFile(msg, Level.WARN));
		 
		 LOGGER.warn("This is {} warn message with args {}","dummy","args1");
		 msg = String.format("This is %s warn message with args %s","dummy","args1");
		 //assertTrue(checkLogFile(msg, Level.WARN)); 
		 
		 LOGGER.warn(SampleApplicationMsgs.WARN_MSG);
	 ...
	 public void testErrorMessages() {
		 String msg = "This is error message for class logger logger";
		 LOGGER.error(msg);
		 //assertTrue(checkLogFile(msg,Level.ERROR));
		 
		 LOGGER.error("This is {} error message with args {}","dummy","args1");
		 msg = String.format("This is %s error message with args %s","dummy","args1");
		 //assertTrue(checkLogFile(msg,Level.ERROR)); 
		 
		 LOGGER.error(SampleApplicationMsgs.ERROR_SERVICE_NOT_RUNNING);
		 //assertTrue(checkLogFile("APP30004E",Level.ERROR)); 
		 
		 LOGGER.error(SampleApplicationMsgs.ERROR_USER_NOT_FOUND, new Date().toString());
	 ...
	 public void testDebugMessages() {
		 String msg = "This is debug message for class logger logger not to be logged";
		 LOGGER.debug(msg);
		 //assertFalse(checkLogFile(msg,Level.DEBUG));
		 
		 LOGGER.debug("This is {} debug message with args {}","dummy","args1");
		 msg = String.format("This is %s debug message with args %s","dummy","args1");
		 //assertFalse(checkLogFile(msg,Level.DEBUG)); 
		 
		 LOGGER.debug(SampleApplicationMsgs.DEBUG_MSG);
		 //assertFalse(checkLogFile("APP10006D",Level.DEBUG)); 
	 }
	 
	 @Test
	 public void testTraceMessages() {
		 String msg = "This is trace message for class logger logger not to be logged";
		 LOGGER.trace(msg);
		 //assertFalse(checkLogFile(msg,Level.TRACE));
		 
		 LOGGER.trace("This is {} trace message with args {}","dummy","args1");
		 msg = String.format("This is %s trace message with args %s","dummy","args1");
		 //assertFalse(checkLogFile(msg,Level.TRACE)); 
		
		 LOGGER.debug(SampleApplicationMsgs.TRACE_MSG);
	 ...
	 public void testChangeLevel() {
		 ...
		 String msg = "This is debug message for class logger logger to be logged";
		 LOGGER.debug(msg);
		 //assertTrue(checkLogFile(msg,Level.DEBUG));
		 
		 LOGGER.setLevel(Level.TRACE);
		 msg = "This is trace message for class logger logger to be logged";
		 LOGGER.trace(msg);
	 ...
	 public void testDisableLevel() {
		 ...
		 String msg = "This is info message for class logger logger not to be logged";
		 LOGGER.info(msg);
		 //assertFalse(checkLogFile(msg, Level.INFO));
		 
		 LOGGER.info("This is {} info message with args {} not to be logged","dummy","args1");
	 ...
	 public void testException() {
		 try {
			 throw new EELFException("Test exception generated");
		 } catch (EELFException ee) {
			 LOGGER.error(SampleApplicationMsgs.MY_SAMPLE_EXCEPTION, ee);
			 LOGGER.debug(SampleApplicationMsgs.MY_SAMPLE_EXCEPTION, ee);
		 }
	 }
	 ...
	 private boolean checkLogFile(String line, Level level) {
		 BufferedReader br = null;
			...
			try {
				...
				br = new BufferedReader(new FileReader("logs/EELF/class logger.log"));
